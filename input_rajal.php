                      ...
                      <div class="col-lg-6 bg-light">
                        <div class="form-group">
                           <label for="nomor_periksa">Nomor Billing</label>                                
                                <?php
                                $nomorbilling_rj = $_POST['nomorbilling_rj'];
                                echo "<input name='nomorbilling_rj' type='text' class='form-control' aria-label='Sizing example input' value='".$nomorbilling_rj."' readonly=''>";
                                ?>
                                            ...
                                            <?php
                                                include 'php/koneksi.php';
                                                  $id_pasien = $_POST['id_pasien'];
                                                    $query=mysqli_query($conn, "SELECT kode_pemeriksaan FROM rawat_jalan WHERE id_pasien = '$id_pasien'");
