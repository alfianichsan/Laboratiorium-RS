...
<!---------------------------------------------------------End Navbar------------------------------------>
  ...
  <div class="content-wrapper">
    ...
    <div id="layoutSidenav_content">
                <main>
                <form method="POST" action="php/rawat_jalan.php">
                <div class="container-fluid mt-3">
                      ...
                      <div class="col-lg-6 bg-light">
                        <div class="form-group">
                           <label for="nomor_periksa">Nomor Periksa</label>                                
                                ...
                                echo "<input name='nomor_periksa' type='text' class='form-control' aria-label='Sizing example input' value='".$id_pasien."' readonly=''>";
                                ?>
                  ...
                  <!---------------------------------------------Group 2-------------------------------------------->
                        <div class="col-lg-6 bg-light">
                            <div class="form-group">
                               <label>Nomor Billing</label>
                                    ...
                                    include "php/koneksi.php";
                                    $query = "SELECT max(nomorbilling_rj) as maxKode FROM rawat_jalan";
                                    $hasil = mysqli_query($conn,$query);
                                    $data = mysqli_fetch_array($hasil);
                                    $nomorbilling_rj = $data['maxKode'];
                                    $noUrut = (int) substr($nomorbilling_rj, 1, 9);
                                    $noUrut++;
                                    $char = "J";
                                    $nomorbilling_rj = $char . sprintf("%03s", $noUrut);
                                    echo "<input name='nomor_billing' type='text' class='form-control' aria-label='Sizing example input' value='".$nomorbilling_rj."' readonly=''>";
                                    ?>
                            </div>
                              ...
                              <div class="col-md-8">
                                    <div class="form-group">
                                        <label>Dokter Pengirim
                                            <button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal_dokter">Data Dokter</button></label>
                                        <input name="nama_dokter" type="text" class="form-control" aria-label="Sizing example input" id="nama_dokter"
                                        value="">
                                    </div>                                
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                              <div class="form-group">
                                <label>Dokter Umum <small>*Di isi Jika Rujukan Dokter Lain</small></label>
                                    <input name="dokter_umum" type="text" class="form-control" aria-label="Sizing example input" placeholder="Nama Dokter Luar">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <?php
                            include 'php/koneksi.php';
                                ...
                                echo "<tr>
                                    ...
                                    <td><input type='button' onclick='myFunction()' id='select' value='".$row['nama_dokter']."'></td>";
                                    ?>
                                    </tr>
                                    <?php
...
<script src="dist/js/demo.js"></script>
    ...
    <script>
        function myFunction() {
          ...
          document.getElementById("nama_dokter").value = x;
        }
    </script>
</body>
</html>
