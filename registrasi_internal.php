...
<!---------------------------------------------------------End Navbar------------------------------------>
  ...
  <div class="content-wrapper">
    ...
    <div id="layoutSidenav_content">
                <main>
                <form method="POST" action="php/registrasi_internal.php">
                <div class="container-fluid mt-3">
                  <div class="row">
                    <!---------------------------------------------Group 1-------------------------------------------->
                      <div class="col-lg-6 bg-light">
                        <div class="form-group">
                           <label for="id_pasien">Nomor Periksa</label>                                
                                <?php
                        ...
                        <div class="col-lg-6 bg-light">
                            <div class="form-group">
                               <label>Nomor Billing</label>
                                    ...
                                    include "php/koneksi.php";
                                          $query = "SELECT max(no_pendaftaran) as maxKode FROM registrasi_internal";
                                          $hasil = mysqli_query($conn,$query);
                                          $data = mysqli_fetch_array($hasil);
                                          $no_pendaftaran = $data['maxKode'];
                                          $date = date("mm-dd");
                                          $exdate = explode('-', $date);
                                          $noUrut = (int) substr($no_pendaftaran, 8, 10);
                                          $noUrut++;
                                          $char = "RG";
                                          $no_pendaftaran = $char . $exdate[0] . sprintf("%03s", $noUrut);
                                    echo "<input name='no_pendaftaran' type='text' class='form-control' aria-label='Sizing example input' value='".$no_pendaftaran."' readonly=''>";
                                    ?>
                            </div>
                              ...
                              <div class="col-md-8">
                                    <div class="form-group">
                                        <label>Pemeriksa</label>
                                            <input name="pemeriksa" type="text" class="form-control" aria-label="Sizing example input" placeholder="Nama Pemeriksa">  
                                    </div>                                
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                  <label>Jam Masuk</label>
                                        <input type="time" name="jam_masuk" class="form-control"  value="<?php echo date("H:i"); ?>" readonly >
                              </div>
                            </div>
                        </div>  
                                      ...
                                      <table class="table table-sm text-center">
                                        ...
                                        <tbody>
                                         ...
                                         <?php
                                          ...
                                          echo "<input name='invoice' type='hidden' class='form-control' aria-label='Sizing example input' value='".$invoice."' readonly=''>";
                                          ?>
                            </div>
                        </div>
