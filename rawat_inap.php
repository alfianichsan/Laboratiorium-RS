...
<!---------------------------------------------------------End Navbar------------------------------------>
  ...
  <div class="content-wrapper">
    ...
    <div id="layoutSidenav_content">
                <main>
                <form method="POST" action="php/rawat_inap.php">
                         ...
                         <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="nama_dokter" type="text" class="form-control" aria-label="Sizing example input" id="nama_dokter" value="" >
                                    </div>                                
                                </div>
                                <div class="col-md-6">
                                <div class="form-group">
                                    <label>Dokter Umum <small>*Di isi Jika Rujukan</small></label>
                        ...
                        <div class="col-lg-6 bg-light">
                            <div class="form-group">
                               <label>Nomor Billing</label>
                                    ...
                                    include "php/koneksi.php";
                                    $query = "SELECT max(no_registrasi) as maxKode FROM rawat_inap";
                                    $hasil = mysqli_query($conn,$query);
                                    $data = mysqli_fetch_array($hasil);
                                    $no_registrasi = $data['maxKode'];
                                    $noUrut = (int) substr($no_registrasi, 1, 9);
                                    $noUrut++;
                                    $char = "R";
